...
public interface RseClient extends ObservableReader.ReaderObserver {
     ...
     */
    String connectReader(ProxyReader localReader, Map<String,Object> options) throws IOException;


    String disconnectReader(ProxyReader localReader) throws IOException;
