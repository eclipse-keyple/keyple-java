 ...
 * asynchronous way
 */
public class VirtualNseSession implements SneSession {

    private static final Logger logger = LoggerFactory.getLogger(org.eclise.keyple.example.remote.server.transport.webservice.rse.VirtualNseSession.class);
    ...
    // constructor
    public VirtualNseSession(String sessionId) {
