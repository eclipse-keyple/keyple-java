...
package org.eclise.keyple.example.remote.server.transport.local.nse;
...
public class LocalNseClient implements NseClient {

    private static final Logger logger = LoggerFactory.getLogger(LocalNseClient.class);
