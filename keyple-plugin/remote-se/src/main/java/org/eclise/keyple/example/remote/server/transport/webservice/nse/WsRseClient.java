...
package org.eclise.keyple.example.remote.server.transport.webservice.nse;
...
public class WsRseClient implements RseClient {
    ...
    public String connectReader(ProxyReader localReader, Map<String,Object> options) throws IOException {
        ...
        Boolean isDuplex = (Boolean) options.get("isDuplex");
        ...
        jsonObject.add("isDuplex", new JsonPrimitive(isDuplex));
        if(isDuplex){
        ...
        JsonObject response =
                HttpHelper.httpPUTJSON(HttpHelper.getConnection(serverUrl + HttpHelper.PLUGIN_ENDPOINT), data);
