 ...
 * Manage SeRequestSet to transmit and receive SeResponseSet in an asynchronous way
 */
public class WsRSEReaderSession implements AsyncRSEReaderSession {
     ...
     */
    public void asyncTransmit(SeRequestSet seRequestSet, SeResponseSetCallback seResponseSetCallback){
    ...
    public void asyncSetSeResponseSet(SeResponseSet seResponseSet){
        ...
        if(this.seRequestSet!=null){
            ...
            logger.warn("Session has been lost, seRequestSet is missing while receiving seResponseSet {}", seResponseSet);
