...
public class EF {
	 ...
	 *            the number rec
	 */
	public EF(byte[] lid, enumSFI sfi, byte fileType, byte recSize, byte numberRec) {
		this.lid = lid;
		this.sfi = sfi;
	...
	public int hashCode() {
		...
		result = prime * result + ((sfi == null) ? 0 : sfi.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if(obj != null){
			EF other = (EF) obj;
			if (getClass() != obj.getClass() || (fileType != other.fileType) || !Arrays.equals(lid, other.lid) || numberRec != other.numberRec
	 ...
	 *            the new sfi
	 */
	public void setSfi(enumSFI sfi) {
		this.sfi = sfi;
	}
