...
import org.keyple.calypso.commandset.dto.POChallenge;
import org.keyple.calypso.commandset.dto.POHalfSessionSignature;
import org.keyple.calypso.commandset.dto.PostponedData;
import org.keyple.calypso.commandset.dto.Ratification;
import org.keyple.calypso.commandset.dto.Record;
...
import org.keyple.calypso.commandset.dto.TransactionCounter;
...
public class ResponseUtils {
    ...
    public static AID toAID(byte[] apduResponse) {
        ...
        if (enumTagUtils.AID_OF_CURRENT_DF_D.getTagbyte2() == firstResponseApdubyte) {
    ...
    public static Ratification isPreviousSessionRatified(byte[] apduResponse, PoRevision revision) {
        ...
        if ((PoRevision.CLASS_0x00 == revision) || (PoRevision.CLASS_0x00 == revision)) {
            flagRatified = apduResponse[5];
            if (flagRatified != 0x01) {
                isPreviousSessionRatified = true;
            }
        } else if (PoRevision.CLASS_0x94 == revision && apduResponse.length < 6) {
            isPreviousSessionRatified = true;
        }
    ...
    public static TransactionCounter toTransactionCounter(byte[] apduResponse, PoRevision revision) {
        ...
        if ((PoRevision.REV3_1 == revision) || (PoRevision.REV3_2== revision)) {
