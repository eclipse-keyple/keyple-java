...
/**
 * Group of SE responses received in response to a {@link SeRequestElement}.
 * 
 * @see SeRequestElement
 */
public class SeResponseElement {
     ...
     */
    public SeResponseElement(boolean channelPreviouslyOpen, ApduResponse fci,
