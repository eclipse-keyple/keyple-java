...
/**
 * List of APDU requests that will result in a {@link SeResponseElement}
 * 
 * @see SeResponseElement
 */
public class SeRequestElement {
     ...
     */
    public SeRequestElement(ByteBuffer aidToSelect, List<ApduRequest> apduRequests,
     ...
     */
    public SeRequestElement(List<ApduRequest> apduRequests) {
    ...
    public String toString() {
        return String.format("SeRequestElement{requests=%s}", getApduRequests());
    }
}
