...
package org.eclipse.keyple.command.csm.parser;
...
public class DigestUpdateRespParsTest {
    ...
    @Test
    public void digestUpdateRespPars() throws InconsistentParameterValueException {
        ...
        Assert.assertArrayEquals(new byte[] {90, 0}, ByteBufferUtils.toBytes(responseActual));
    }
}
