...
Depending on the targetting usage: implementation of a ticketing <span style="color:blue">**application**</span>, a reader <font color="red">**plugin**</font>, or a **SE library**, only specific Keyple packages must be imported.
