...
import static org.eclipse.keyple.example.calypso.Demo_CalypsoClassic.CardSelectionConfig.getPoDefaultCardSelection;
import static org.eclipse.keyple.example.calypso.Demo_CalypsoClassic.CardSelectionConfig.selectSam;
...
class CardReaderObserver implements ObservableReader.ReaderObserver {
  private static final Logger logger = LoggerFactory.getLogger(CardSelectionConfig.class);
   ...
   * @param poReader the current PO {@link Reader}
