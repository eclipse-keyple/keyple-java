...
/**
 * Web service factory, get {@link WsPClient} and {@link WsPServer} @Deprecated
 *
 * <p>Use {@link
 * org.eclipse.keyple.example.remote.transport.wspolling.client_retrofit.WsPollingFactory} instead
 */
@Deprecated
...
public class WsPollingFactory extends TransportFactory {
  ...
  public ClientNode getClient(String clientNodeId) {
    ...
    return new WsPClient(
        protocol + bindUrl + ":" + port, keypleUrl, pollingUrl, clientNodeId, serverNodeId);
  }
