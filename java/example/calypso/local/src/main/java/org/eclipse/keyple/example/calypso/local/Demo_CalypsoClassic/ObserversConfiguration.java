...
public class ObserversConfiguration {
     ...
     *
     * <ol>
     *   <li>Setting up a two-reader configuration and adding an observer method ({@link #update
     *       update})
     ...
     */
    static public class ReaderObserver implements ObservableReader.ReaderObserver {

        private final Logger logger =
                LoggerFactory.getLogger(ReaderObserver.class);
         ...
         */
        public void doCalypsoReadWriteTransaction(
        ...
        public void operateCalypsoTransaction(AbstractDefaultSelectionsResponse defaultSelectionsResponse) {
            CalypsoPo calypsoPo =
                    (CalypsoPo)
        ...
        public void update(ReaderEvent event) {
            ...
            switch (event.getEventType()) {
                ...
                case CARD_MATCHED:
                    operateCalypsoTransaction(event.getDefaultSelectionsResponse());
                    break;
