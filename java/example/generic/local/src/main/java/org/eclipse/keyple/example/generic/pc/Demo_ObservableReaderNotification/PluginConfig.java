...
class PluginConfig {
  ...
  private static ObservablePlugin.PluginObserver getObserver(
      final ObservableReader.ReaderObserver aReaderObserver) {
    return new ObservablePlugin.PluginObserver() {
      ObservableReader.ReaderObserver readerObserver = aReaderObserver;
