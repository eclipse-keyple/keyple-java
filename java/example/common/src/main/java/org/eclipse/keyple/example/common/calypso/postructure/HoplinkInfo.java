 ...
 *
 * <ul>
 *   <li>AID application selection
 *   <li>SAM_C1_ATR_REGEX regular expresion matching the expected C1 SAM ATR
 *   <li>Files infos (SFI, rec number, etc) for T2 Environment and T2 Usage
 * </ul>
 */
public class HoplinkInfo {
  /** Hoplink card AID */
  public static final String AID = "A000000291A000000191";
  ...
  public static final String t2UsageRecord1_dataFill =
  ...
  public static final byte SFI_T2Usage = (byte) 0x1A;
  public static final byte SFI_T2Environment = (byte) 0x14;

  public static final String EXTRAINFO_ReadRecord_T2UsageRec1 =
      String.format("T2 Usage (SFI=%02X, recnbr=%d))", SFI_T2Usage, RECORD_NUMBER_1);
  public static final String EXTRAINFO_ReadRecord_T2EnvironmentRec1 =
      String.format("T2 Environment (SFI=%02X, recnbr=%d))", SFI_T2Environment, RECORD_NUMBER_1);
}
