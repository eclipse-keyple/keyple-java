...
public class HoplinkInfo {
    ...
    public static final String t2UsageRecord1_dataFill = "0102030405060708090A0B0C0D0E0F10"
    ...
    public static final String EXTRAINFO_ReadRecord_T2EnvironmentRec1 = String
