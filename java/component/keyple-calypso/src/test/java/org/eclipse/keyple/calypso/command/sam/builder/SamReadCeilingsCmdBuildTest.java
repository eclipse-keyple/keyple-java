...
public class SamReadCeilingsCmdBuildTest {
  ...
  public void samReadCeilingsCmdBuild_defaultRevision_createParser() {
    SamReadCeilingsCmdBuild samReadCeilingsCmdBuild =
        new SamReadCeilingsCmdBuild(
            null, SamReadCeilingsCmdBuild.CeilingsOperationType.SINGLE_CEILING, INDEX1);
  ...
  public void samReadCeilingsCmdBuild_cla94() {
    SamReadCeilingsCmdBuild samReadCeilingsCmdBuild =
        new SamReadCeilingsCmdBuild(
            SamRevision.S1D, SamReadCeilingsCmdBuild.CeilingsOperationType.SINGLE_CEILING, INDEX1);
    assertThat(samReadCeilingsCmdBuild.getApduRequest().getBytes())
  ...
  public void samReadCeilingsCmdBuild_cla80_single() {
    SamReadCeilingsCmdBuild samReadCeilingsCmdBuild =
        new SamReadCeilingsCmdBuild(
            SamRevision.C1, SamReadCeilingsCmdBuild.CeilingsOperationType.SINGLE_CEILING, INDEX1);
    assertThat(samReadCeilingsCmdBuild.getApduRequest().getBytes())
        .isEqualTo(ByteArrayUtil.fromHex(APDU_CLA_80_SINGLE));
  }
  ...
  public void samReadCeilingsCmdBuild_cla80_record() {
    SamReadCeilingsCmdBuild samReadCeilingsCmdBuild =
        new SamReadCeilingsCmdBuild(
            SamRevision.C1, SamReadCeilingsCmdBuild.CeilingsOperationType.CEILING_RECORD, INDEX1);
    assertThat(samReadCeilingsCmdBuild.getApduRequest().getBytes())
  ...
  public void samReadCeilingsCmdBuild_cla80_single_indexOutOfBound_1() {
    new SamReadCeilingsCmdBuild(
        SamRevision.C1, SamReadCeilingsCmdBuild.CeilingsOperationType.CEILING_RECORD, INDEX_M1);
  ...
  public void samReadCeilingsCmdBuild_cla80_single_indexOutOfBound_2() {
    new SamReadCeilingsCmdBuild(
        SamRevision.C1, SamReadCeilingsCmdBuild.CeilingsOperationType.CEILING_RECORD, INDEX27);
    shouldHaveThrown(IllegalArgumentException.class);
  }
  ...
  public void samReadCeilingsCmdBuild_cla80_record_indexOutOfBound_2() {
    new SamReadCeilingsCmdBuild(
        SamRevision.C1, SamReadCeilingsCmdBuild.CeilingsOperationType.CEILING_RECORD, INDEX4);
    shouldHaveThrown(IllegalArgumentException.class);
  }
}
