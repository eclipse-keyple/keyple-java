...
public class SamWriteKeyCmdBuildTest {
  ...
  public void samWriteKeyCmdBuild_defaultRevision_createParser() {
    SamWriteKeyCmdBuild samWriteKeyCmdBuild =
        new SamWriteKeyCmdBuild(null, WRITING_MODE, KEY_REF, ByteArrayUtil.fromHex(KEY_DATA));
  ...
  public void samWriteKeyCmdBuild_cla94() {
    SamWriteKeyCmdBuild samWriteKeyCmdBuild =
        new SamWriteKeyCmdBuild(
            SamRevision.S1D, WRITING_MODE, KEY_REF, ByteArrayUtil.fromHex(KEY_DATA));
    assertThat(samWriteKeyCmdBuild.getApduRequest().getBytes())
  ...
  public void samWriteKeyCmdBuild_cla80() {
    SamWriteKeyCmdBuild samWriteKeyCmdBuild =
        new SamWriteKeyCmdBuild(
            SamRevision.C1, WRITING_MODE, KEY_REF, ByteArrayUtil.fromHex(KEY_DATA));
    assertThat(samWriteKeyCmdBuild.getApduRequest().getBytes())
        .isEqualTo(ByteArrayUtil.fromHex(APDU_CLA_80));
  }
  ...
  public void samWriteKeyCmdBuild_badSignatureLength_1() {
    new SamWriteKeyCmdBuild(
        null, WRITING_MODE, KEY_REF, ByteArrayUtil.fromHex(KEY_DATA_BAD_LENGTH1));
    shouldHaveThrown(IllegalArgumentException.class);
  }
  ...
  public void samWriteKeyCmdBuild_badSignatureLength_2() {
    new SamWriteKeyCmdBuild(
        null, WRITING_MODE, KEY_REF, ByteArrayUtil.fromHex(KEY_DATA_BAD_LENGTH2));
    shouldHaveThrown(IllegalArgumentException.class);
  }
}
