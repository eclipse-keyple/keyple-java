...
public class DigestCloseRespParsTest {
  ...
  public void digestCloseRespPars_badStatus() {
    DigestCloseRespPars digestCloseRespPars =
        new DigestCloseRespPars(new ApduResponse(ByteArrayUtil.fromHex(SW1SW2_KO), null), null);
  ...
  public void digestCloseRespPars_goodStatus_getSignature() {
    DigestCloseRespPars digestCloseRespPars =
        new DigestCloseRespPars(
            new ApduResponse(ByteArrayUtil.fromHex(APDU_DIGEST_CLOSE), null), null);
    digestCloseRespPars.checkStatus();
    assertThat(digestCloseRespPars.getSignature()).isEqualTo(ByteArrayUtil.fromHex(SAM_SIGNATURE));
  }
}
