...
public class SamWriteKeyRespParsTest {
  ...
  public void samWriteKeyRespPars_badStatus() {
    SamWriteKeyRespPars samWriteKeyRespPars =
        new SamWriteKeyRespPars(new ApduResponse(ByteArrayUtil.fromHex(SW1SW2_KO), null), null);
  ...
  public void samWriteKeyRespPars_goodStatus() {
    SamWriteKeyRespPars samWriteKeyRespPars =
        new SamWriteKeyRespPars(new ApduResponse(ByteArrayUtil.fromHex(SW1SW2_OK), null), null);
    samWriteKeyRespPars.checkStatus();
  }
}
