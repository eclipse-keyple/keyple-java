...
public class IncreaseRespParsTest {
  ...
  public void increaseRespPars_badStatus() {
    IncreaseRespPars increaseRespPars =
        new IncreaseRespPars(new ApduResponse(ByteArrayUtil.fromHex(APDU_BAD_SW1SW2), null), null);
  ...
  public void increaseRespPars_goodStatus() {
    IncreaseRespPars increaseRespPars =
        new IncreaseRespPars(new ApduResponse(ByteArrayUtil.fromHex(APDU_INCREASE), null), null);
    increaseRespPars.checkStatus();
  }
