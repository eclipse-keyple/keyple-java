...
public class OpenSessionCmdBuildTest {
  ...
  public void openSessionCmdBuild_rev_2_4_exception() {
    ...
    apduCommandBuilder =
        AbstractOpenSessionCmdBuild.create(
            PoRevision.REV2_4, keyIndex, samChallenge, sfiToSelect, recordNumberToRead);
  }
  ...
  public void openSessionCmdBuild_rev_2_4() {
    ...
    apduCommandBuilder =
        AbstractOpenSessionCmdBuild.create(
            PoRevision.REV2_4, keyIndex, dataIn, sfiToSelect, recordNumberToRead);
  ...
  public void openSessionCmdBuild_rev_3_1() {
    ...
    apduCommandBuilder =
        AbstractOpenSessionCmdBuild.create(
            PoRevision.REV3_1, keyIndex, dataIn, sfiToSelect, recordNumberToRead);
    apduRequest = apduCommandBuilder.getApduRequest();
  ...
  public void openSessionCmdBuild_rev_3_2() {
    ...
    apduCommandBuilder =
        AbstractOpenSessionCmdBuild.create(
            PoRevision.REV3_2, keyIndex, samChallenge, sfiToSelect, recordNumberToRead);
    apduRequest = apduCommandBuilder.getApduRequest();
    Assert.assertEquals(
        ByteArrayUtil.toHex(request3_2), ByteArrayUtil.toHex(apduRequest.getBytes()));
  }
}
