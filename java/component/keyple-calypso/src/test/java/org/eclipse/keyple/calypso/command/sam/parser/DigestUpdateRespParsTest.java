...
public class DigestUpdateRespParsTest {
  ...
  public void digestUpdateRespPars_badStatus() {
    DigestUpdateRespPars digestUpdateRespPars =
        new DigestUpdateRespPars(new ApduResponse(ByteArrayUtil.fromHex(SW1SW2_KO), null), null);
    digestUpdateRespPars.checkStatus();
    shouldHaveThrown(CalypsoSamCommandException.class);
  }

  @Test
  public void digestUpdateRespPars_goodStatus() {
    DigestUpdateRespPars digestUpdateRespPars =
        new DigestUpdateRespPars(new ApduResponse(ByteArrayUtil.fromHex(SW1SW2_OK), null), null);
    digestUpdateRespPars.checkStatus();
  }
}
