...
public class SvGetRespParsTest {
  ...
  public void modeRevision3_2_base() {
    ...
    Assert.assertArrayEquals(
        ByteArrayUtil.fromHex("0011223344556677"), svGetRespPars.getChallengeOut());
    ...
    Assert.assertArrayEquals(
        ByteArrayUtil.fromHex("665544332211"), svGetRespPars.getPreviousSignatureLo());
    // TODO Review this
  ...
  public void modeRevision3_2_B1_LB_1_LA_1_DB_1_DA_1() {
    ...
    ApduResponse apduResponse =
        new ApduResponse(
            ByteArrayUtil.fromHex(
                "001122334455667755A55A665544332211"
                    +
                    /* B 1 */ "000001"
                    + "123422AA33"
                    +
                    /* LB 1 LA 1 */ "000001000001"
                    + "5678AABBCCDD1234564567"
                    +
                    /* DA 1 */ "0001"
                    + "12356789BBBBCCDDEE234567"
                    +
                    /* DB 1 */ "000001"
                    + "45689000"),
            null);
        ...
        new ApduResponse(
            ByteArrayUtil.fromHex(
                "001122334455667755A55A665544332211"
                    ...
                    + "123422AA33"
                    +
                    /* LB 65537 LA 65536 */ "010001010000"
                    + "5678AABBCCDD1234564567"
                    +
                    /* DA -32768 */ "8000"
                    + "12356789BBBBCCDDEE234567"
        ...
        new ApduResponse(
            ByteArrayUtil.fromHex(
                "001122334455667755A55A665544332211"
                    ...
                    + "123422AA33"
                    +
                    /* LB 8388606 LA 8388607 */ "7FFFFF7FFFFF"
                    + "5678AABBCCDD1234564567"
                    +
                    /* DA 32767 */ "7FFF"
                    + "12356789BBBBCCDDEE234567"
        ...
        new ApduResponse(
            ByteArrayUtil.fromHex(
                "001122334455667755A55A665544332211"
                    ...
                    + "123422AA33"
                    +
                    /* LB -8388608 LA -8388608 */ "800000800000"
                    + "5678AABBCCDD1234564567"
                    +
                    /* DA -32768 */ "8000"
                    + "12356789BBBBCCDDEE234567"
  ...
  public void modeCompat_base_Reload() {
    ...
    Assert.assertEquals(0xA55A, svGetRespPars.getTransactionNumber());
    Assert.assertArrayEquals(
        ByteArrayUtil.fromHex("665544"), svGetRespPars.getPreviousSignatureLo());
    // TODO Review this
    // /* check load log fields */
    // Assert.assertArrayEquals(ByteArrayUtil.fromHex("1234"),
    // svGetRespPars.getLoadLog().getDate());
