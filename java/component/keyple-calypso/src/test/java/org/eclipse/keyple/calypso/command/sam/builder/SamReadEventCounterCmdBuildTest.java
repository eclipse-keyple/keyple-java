...
public class SamReadEventCounterCmdBuildTest {
  ...
  public void samReadEventCounterCmdBuild_defaultRevision_createParser() {
    SamReadEventCounterCmdBuild samReadEventCounterCmdBuild =
        new SamReadEventCounterCmdBuild(
            null, SamReadEventCounterCmdBuild.SamEventCounterOperationType.SINGLE_COUNTER, INDEX1);
    ...
    assertThat(samReadEventCounterRespPars.getClass()).isEqualTo(SamReadEventCounterRespPars.class);
  }
  ...
  public void samReadEventCounterCmdBuild_cla94() {
    SamReadEventCounterCmdBuild samReadEventCounterCmdBuild =
        new SamReadEventCounterCmdBuild(
            SamRevision.S1D,
            SamReadEventCounterCmdBuild.SamEventCounterOperationType.SINGLE_COUNTER,
            INDEX1);
    assertThat(samReadEventCounterCmdBuild.getApduRequest().getBytes())
  ...
  public void samReadEventCounterCmdBuild_cla80_record() {
    SamReadEventCounterCmdBuild samReadEventCounterCmdBuild =
        new SamReadEventCounterCmdBuild(
            SamRevision.C1,
            SamReadEventCounterCmdBuild.SamEventCounterOperationType.COUNTER_RECORD,
            INDEX1);
    assertThat(samReadEventCounterCmdBuild.getApduRequest().getBytes())
