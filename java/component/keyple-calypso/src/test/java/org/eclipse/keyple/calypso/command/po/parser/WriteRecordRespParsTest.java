...
public class WriteRecordRespParsTest {
  ...
  public void writeRecordRespPars_badStatus() {
    WriteRecordRespPars writeRecordRespPars =
        new WriteRecordRespPars(new ApduResponse(ByteArrayUtil.fromHex(SW1SW2_KO), null), null);
  ...
  public void writeRecordRespPars_goodStatus() {
    WriteRecordRespPars writeRecordRespPars =
        new WriteRecordRespPars(new ApduResponse(ByteArrayUtil.fromHex(SW1SW2_OK), null), null);
    writeRecordRespPars.checkStatus();
  }
}
