...
public class GiveRandomRespParsTest {
  ...
  public void giveRandomRespPars_badStatus() {
    GiveRandomRespPars giveRandomRespPars =
        new GiveRandomRespPars(new ApduResponse(ByteArrayUtil.fromHex(SW1SW2_KO), null), null);
  ...
  public void giveRandomRespPars_goodStatus() {
    GiveRandomRespPars giveRandomRespPars =
        new GiveRandomRespPars(new ApduResponse(ByteArrayUtil.fromHex(SW1SW2_OK), null), null);
    giveRandomRespPars.checkStatus();
  }
}
