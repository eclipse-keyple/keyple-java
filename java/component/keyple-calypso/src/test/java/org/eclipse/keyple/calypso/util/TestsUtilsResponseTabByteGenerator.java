...
public class TestsUtilsResponseTabByteGenerator {
  ...
  public byte[] generate4MultiRecordsTabByte() {
    return new byte[] {
      0x01, 0x01, 0x01, 0x01, 0x30, 0x01, 0x01, 0x30, 0x01, 0x01, 0x30, 0x01, 0x01, 0x30
    };
  }
  ...
  public static ApduResponse generateApduResponseValidRev2_4() {
    return new ApduResponse(
        append(
            generateResponseOkTabByteRev2_4(),
  ...
  public static ApduResponse generateApduResponseValidRev3_1() {
    return new ApduResponse(
        append(
            generateResponseOkTabByteRev3_1(),
            TestsUtilsStatusCodeGenerator.generateSuccessfulStatusCode()),
        null);
  }
  ...
  public static ApduResponse generateApduResponseValidRev3_2() {
    return new ApduResponse(
        append(
            generateResponseOkTabByteRev3_2(),
            TestsUtilsStatusCodeGenerator.generateSuccessfulStatusCode()),
        null);
  }
  ...
  public static ApduResponse generateApduResponseTerminalSessionSignatureCmd() {
    return new ApduResponse(
        append(
            generateTerminalSessionSignatureTabByte(),
            TestsUtilsStatusCodeGenerator.generateSuccessfulStatusCode()),
        null);
  }
  ...
  public static ApduResponse generateApduResponseFciCmd() {
    return new ApduResponse(
        append(generateFciTabByte(), TestsUtilsStatusCodeGenerator.generateSuccessfulStatusCode()),
        null);
  }
  ...
  public static ApduResponse generateApduResponseFciCmdError() {
    return new ApduResponse(
        append(
            generateFciTabByte(), TestsUtilsStatusCodeGenerator.generateFileNotFoundStatusCode()),
        null);
  }
}
