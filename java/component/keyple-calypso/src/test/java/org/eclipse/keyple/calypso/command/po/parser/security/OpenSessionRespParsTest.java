...
public class OpenSessionRespParsTest {
  ...
  private static final String OPEN_SECURE_SESSION_RESP_24_KVC_RATIFIED = KVC + PO_TN + PO_RANDOM_1;
  ...
  public void openSessionRespPars_rev1_0_readingData() {
    ...
    AbstractOpenSessionCmdBuild<AbstractOpenSessionRespPars> openSessionCmdBuild =
        AbstractOpenSessionCmdBuild.create(
            ...
            SFI,
            REC);
    AbstractOpenSessionRespPars responseParser = openSessionCmdBuild.createResponseParser(response);
  ...
  public void openSessionRespPars_rev1_0_readingData_notRatified() {
    ApduResponse response =
        new ApduResponse(
            ByteArrayUtil.fromHex(OPEN_SECURE_SESSION_RESP_10_KVC_NOT_RATIFIED + DATA + SW1SW2_OK),
            null);
    AbstractOpenSessionCmdBuild<AbstractOpenSessionRespPars> openSessionCmdBuild =
        AbstractOpenSessionCmdBuild.create(
            PoRevision.REV1_0,
  ...
  public void openSessionRespPars_rev1_0_notReadingData_notRatified() {
    ApduResponse response =
        new ApduResponse(
            ByteArrayUtil.fromHex(OPEN_SECURE_SESSION_RESP_10_KVC_NOT_RATIFIED + SW1SW2_OK), null);
    AbstractOpenSessionCmdBuild<AbstractOpenSessionRespPars> openSessionCmdBuild =
        AbstractOpenSessionCmdBuild.create(
            PoRevision.REV1_0,
            PoTransaction.SessionSetting.AccessLevel.SESSION_LVL_DEBIT.getSessionKey(),
  ...
  public void openSessionRespPars_rev2_4_readingData_notRatified() {
    ApduResponse response =
        new ApduResponse(
            ByteArrayUtil.fromHex(OPEN_SECURE_SESSION_RESP_24_KVC_NOT_RATIFIED + DATA + SW1SW2_OK),
            null);
    AbstractOpenSessionCmdBuild<AbstractOpenSessionRespPars> openSessionCmdBuild =
        AbstractOpenSessionCmdBuild.create(
            PoRevision.REV2_4,
  ...
  public void openSessionRespPars_rev2_4_notReadingData_notRatified() {
    ApduResponse response =
        new ApduResponse(
            ByteArrayUtil.fromHex(OPEN_SECURE_SESSION_RESP_24_KVC_NOT_RATIFIED + SW1SW2_OK), null);
    AbstractOpenSessionCmdBuild<AbstractOpenSessionRespPars> openSessionCmdBuild =
        AbstractOpenSessionCmdBuild.create(
            PoRevision.REV2_4,
            PoTransaction.SessionSetting.AccessLevel.SESSION_LVL_DEBIT.getSessionKey(),
  ...
  public void openSessionRespPars_rev3_1_notReadingData() {
    ApduResponse response =
        new ApduResponse(
            ByteArrayUtil.fromHex(OPEN_SECURE_SESSION_RESP_31_RATIFIED + DATA_LENGTH_0 + SW1SW2_OK),
            null);
    AbstractOpenSessionCmdBuild<AbstractOpenSessionRespPars> openSessionCmdBuild =
        AbstractOpenSessionCmdBuild.create(
            PoRevision.REV3_1,
  ...
  public void openSessionRespPars_rev3_2_notReadingData() {
    ApduResponse response =
        new ApduResponse(
            ByteArrayUtil.fromHex(OPEN_SECURE_SESSION_RESP_32_RATIFIED + DATA_LENGTH_0 + SW1SW2_OK),
            null);
    AbstractOpenSessionCmdBuild<AbstractOpenSessionRespPars> openSessionCmdBuild =
        AbstractOpenSessionCmdBuild.create(
            PoRevision.REV3_2,
