 ...
 */
public class CalypsoPoAccessForbiddenException extends CalypsoPoCommandException {
     ...
     */
    public CalypsoPoAccessForbiddenException(String message, CalypsoPoCommand command,
            Integer statusCode) {
