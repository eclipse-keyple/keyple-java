 ...
 *
 * <p>Provides methods fot the allocation/deallocation of SAM resources
 */
public abstract class SamResourceManager {
   ...
   *
   * <p>In the case where the allocation mode is BLOCKING, this method will wait until a SAM
   ...
   *
   * <p>In the case where the allocation mode is NON_BLOCKING and no SAM resource is available, this
   * method will return an exception.
   *
   * <p>If the samGroup argument is null, the first available SAM resource will be selected and
   ...
   *
   * <p>Proceed with the SAM selection and combine the SAM reader and the Calypso SAM resulting from
   * the selection.
   *
