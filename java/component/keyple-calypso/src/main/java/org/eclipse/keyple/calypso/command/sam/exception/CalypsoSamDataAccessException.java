 ...
 */
public class CalypsoSamDataAccessException extends CalypsoSamCommandException {
     ...
     */
    public CalypsoSamDataAccessException(String message, CalypsoSamCommand command,
            Integer statusCode) {
