...
public final class SvReloadRespPars extends AbstractPoResponseParser {
    ...
    static {
        ...
        m.put(0x6900, new StatusProperties("Transaction counter is 0 or SV TNum is FFFEh or FFFFh.",
        ...
        m.put(0x6988, new StatusProperties("Incorrect signatureHi.",
                CalypsoPoSecurityDataException.class));
        m.put(0x6200, new StatusProperties(
