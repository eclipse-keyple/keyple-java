...
public class VerifyPinRespPars extends AbstractPoResponseParser {
    ...
    static {
        ...
        m.put(0x6700,
                new StatusProperties("Lc value not supported (only 00h, 04h or 08h are supported).",
        ...
        m.put(0x63C1, new StatusProperties("Incorrect PIN (1 attempt remaining).",
                CalypsoPoPinException.class));
        m.put(0x63C2, new StatusProperties("Incorrect PIN (2 attempt remaining).",
                CalypsoPoPinException.class));
        m.put(0x6983, new StatusProperties("Presentation rejected (PIN is blocked).",
                CalypsoPoPinException.class));
        m.put(0x6D00, new StatusProperties("PIN function not present.",
                CalypsoPoIllegalParameterException.class));
        STATUS_TABLE = m;
    }
