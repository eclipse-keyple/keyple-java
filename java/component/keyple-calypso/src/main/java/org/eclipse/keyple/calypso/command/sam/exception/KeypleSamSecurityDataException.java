 ...
 * incorrect.
 */
public class KeypleSamSecurityDataException extends KeypleSamCommandException {
     ...
     */
    public KeypleSamSecurityDataException(String message, CalypsoSamCommand command,
            Integer statusCode) {
