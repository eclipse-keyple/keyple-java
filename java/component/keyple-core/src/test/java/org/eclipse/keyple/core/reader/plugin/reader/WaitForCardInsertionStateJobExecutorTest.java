...
public class WaitForCardInsertionStateJobExecutorTest extends CoreBaseTest {

  private static final Logger logger =
      LoggerFactory.getLogger(WaitForCardInsertionStateJobExecutorTest.class);
  ...
  public void setUp() {
    ...
    waitForInsert =
        new WaitForCardInsertionState(r, new SmartInsertionMonitoringJob(r), executorService);
  }
  ...
  public void testInsertSe_Error() throws Exception {
     ...
     */
    // card not matched
    doReturn(null).when(r).processCardInserted();
    doReturn(true).when(r).waitForCardPresent();
  ...
  // waitForInsert = new WaitForCardInsertionState(r, executorService);
  //
  // /* test */
  // waitForInsert.onActivate();
  //
