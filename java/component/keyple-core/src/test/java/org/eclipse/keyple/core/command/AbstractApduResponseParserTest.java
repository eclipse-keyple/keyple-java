...
public class AbstractApduResponseParserTest extends CoreBaseTest {
  ...
  public void testApduSuccessful1() {
    ...
    Assert.assertArrayEquals(
        ByteArrayUtil.fromHex("9000"), apduResponseParser.getApduResponse().getBytes());
  ...
  public void testApduSuccessful2() {
    ...
    Assert.assertArrayEquals(
        ByteArrayUtil.fromHex("9999"), apduResponseParser.getApduResponse().getBytes());
    Assert.assertTrue(apduResponseParser.isSuccessful());
  ...
  public void testApduUnsuccessful() {
    ...
    Assert.assertArrayEquals(
        ByteArrayUtil.fromHex("6500"), apduResponseParser.getApduResponse().getBytes());
