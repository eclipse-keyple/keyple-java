...
public class AbstractIso7816CommandBuilderTest extends CoreBaseTest {
  ...
  public void testConstructor1() {
    ...
    Assert.assertArrayEquals(
        ByteArrayUtil.fromHex("AABBCCDDEEFF00"), iso7816CommandBuilder.getApduRequest().getBytes());
  ...
  public void testSetApduRequestCase1() {
    ...
    ApduRequest apduRequest =
        iso7816CommandBuilder.setApduRequest(
            (byte) 0xCC, CommandRef.COMMAND_1, (byte) 0xB1, (byte) 0xB2, null, null);
  ...
  public void testSetApduRequestCase2() {
    ...
    ApduRequest apduRequest =
        iso7816CommandBuilder.setApduRequest(
            (byte) 0xCC, CommandRef.COMMAND_1, (byte) 0xB1, (byte) 0xB2, null, (byte) 6);
  ...
  public void testSetApduRequestCase3() {
    ...
    Assert.assertArrayEquals(
        ByteArrayUtil.fromHex("CC 11 B1 B2 04 11223344"), apduRequest.getBytes());
    Assert.assertFalse(apduRequest.isCase4());
  }
  ...
  public void testSetApduRequestCase4() {
    ...
    Assert.assertArrayEquals(
        ByteArrayUtil.fromHex("CC 11 B1 B2 04 11223344 00"), apduRequest.getBytes());
  ...
  public enum CommandRef implements SeCommand {
