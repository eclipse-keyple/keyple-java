...
class VirtualReaderSessionFactory {
   ...
   */
  public VirtualReaderSession createSession(
      String nativeReaderName, String slaveNodeId, String masterNodeId) {
    return new VirtualReaderSessionImpl(
        generateSessionId(nativeReaderName, slaveNodeId), slaveNodeId, masterNodeId);
  }
