...
public class SlaveAPI implements INativeReaderService, DtoHandler, ObservableReader.ReaderObserver {
    ...
    public TransportDto onDTO(TransportDto transportDto) {
        ...
        logger.debug("{} Remote Method called : {} - isRequest : {}",dtoNode.getNodeId(), method, keypleDTO.isRequest());
        ...
        logger.trace("{} onDto response to be sent {}", dtoNode.getNodeId(), KeypleDtoHelper.toJson(out.getKeypleDTO()));
        return out;
    ...
    public String connectReader(ProxyReader localReader) throws KeypleReaderException {
        ...
        logger.info("{} connectReader {} from device {}",dtoNode.getNodeId(), localReader.getName(), dtoNode.getNodeId());
    ...
    public void disconnectReader(String sessionId, String nativeReaderName)
        ...
        logger.info("{} disconnectReader {} from device {}",dtoNode.getNodeId(), nativeReaderName, dtoNode.getNodeId());
