 ...
 *
 * <p>The implementation can be enriched with network layer information. For instance, it can embed
 * web socket connection information
 *
 * <p>This message transits from the DtoNode to the Keyple layers, back to the DtoNode. Use the
 * method #nextTransportDTO() to build a new container message from a keypleDto.
 *
 * <p>If you don't need to wrap a KeypleDto with additional info, you can use the {@link
 * DefaultTransportDto}
 */
