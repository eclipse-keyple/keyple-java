...
/**
 * Utility class to manipulate KeypleDto. Use this class to build the different types of {@link
 * KeypleDto}
 *
 * <ul>
 *   <li>Request
...
public final class KeypleDtoHelper {
   ...
   */
  public static KeypleDto buildRequest(
      String action,
      String body,
      String sessionId,
   ...
   */
  public static KeypleDto buildResponse(
      String action,
      String body,
      String sessionId,
      String nativeReaderName,
   ...
   */
  public static KeypleDto buildNotification(
      String action,
      String body,
      String sessionId,
      String nativeReaderName,
   ...
   *
   * <p>This keypleDto send the exception to the other node
   *
   ...
   */
  public static KeypleDto ExceptionDTO(
      String action,
      Exception exception,
      String sessionId,
      String nativeReaderName,
    ...
    return build(
        ...
        targetNodeId,
        id,
        JsonParser.getGson().toJson(exception));
  }

  /**
   * Build a keypleDto of type "NoResponse". This Dto should be not be sent by the {@link
   * org.eclipse.keyple.plugin.remotese.transport.DtoNode}.
   *
   * @param id : id of the request
  ...
  private static KeypleDto build(
      String action,
      String body,
      boolean isRequest,
      String sessionId,
