...
public class StubPoolPlugin implements ReaderPoolPlugin {
    ...
    public void releaseReader(SeReader seReader) {
        try {
            ...
            throw new IllegalStateException("Impossible to release reader, reader with name was not found in stubplugin : " + seReader.getName());
        }
    }
    ...
    @Override
    public void setParameters(Map<String, String> parameters) throws IllegalArgumentException, KeypleBaseException {
