...
import org.eclipse.keyple.plugin.remote.core.exception.KeypleClosedSessionException;
...
public final class KeypleServerAsyncNodeImpl extends AbstractKeypleNode
  ...
  KeypleServerAsyncNodeImpl(
      AbstractKeypleMessageHandler handler, KeypleServerAsync endpoint, int timeoutInSecond) {
