 ...
 *
 * <p>This service must be used in the use case of the <b>Remote SE Server Plugin</b>.
 *
 * <p>It must be started by a <b>client</b> application that is installed on a terminal with native
 * access to the SE card reader :
 *
 * <ul>
 *   <li>To <b>start</b> the service, use the factory {@link NativeSeClientServiceFactory}.
 *   <li>To <b>access</b> the service, use the utility method {@link
 *       NativeSeClientUtils#getService()}.
...
public interface NativeSeClientService {
  ...
  /**
   * This method allows you to connect a native SE reader to a remote server and execute a specific
