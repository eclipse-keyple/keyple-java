 ...
 ************************************************************************************** */
package org.eclipse.keyple.example.generic.remote.poolclient.webservice.server;
...
import org.eclipse.keyple.example.generic.remote.poolclient.webservice.util.CalypsoSmartCard;
...
public class AppServer {
  ...
  private ReaderPoolPlugin poolPlugin;

  /**
   * Initialize the server components :
   *
   * <ul>
   *   <li>A {@link ReaderPoolPlugin} with a {@link StubPoolPlugin} with a inserted card,
