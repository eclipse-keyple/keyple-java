...
public class ClientApp {
  ...
  @Inject WebsocketClientEndpoint clientEndpoint;
   ...
   * SeCommonProtocols.PROTOCOL_ISO14443_4. Initialize the nativeSeService with and async endpoint
   * {@link WebsocketClientEndpoint}
   */
  public void init() {
