...
public class VirtualObservableReaderTest {
    ...
    static final KeypleMessageDto response = new KeypleMessageDto()
    ...
    public void setDefaultSelectionRequest_shouldSendDto() {
        reader.setDefaultSelectionRequest(abstractDefaultSelectionsRequest, notificationMode,
                pollingMode);
        ...
        JsonObject body =
                KeypleJsonParser.getParser().fromJson(request.getBody(), JsonObject.class);
        assertThat(KeypleJsonParser.getParser().fromJson(body.get("defaultSelectionsRequest"),
                DefaultSelectionsRequest.class)).isEqualToComparingFieldByFieldRecursively(
                        abstractDefaultSelectionsRequest);
        assertThat(KeypleJsonParser.getParser().fromJson(body.get("notificationMode").getAsString(),
                ObservableReader.NotificationMode.class))
                        .isEqualToComparingFieldByFieldRecursively(notificationMode);
        assertThat(KeypleJsonParser.getParser().fromJson(body.get("pollingMode").getAsString(),
                ObservableReader.PollingMode.class))
