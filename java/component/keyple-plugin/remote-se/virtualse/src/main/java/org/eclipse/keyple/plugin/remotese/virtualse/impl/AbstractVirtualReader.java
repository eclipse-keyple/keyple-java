 ...
 * <p>
 * This object is a {@link AbstractReader} with additional features.
 */
abstract class AbstractVirtualReader extends AbstractReader {
    ...
    protected List<SeResponse> processSeRequests(List<SeRequest> seRequests,
        ...
        body.addProperty("seRequests", KeypleJsonParser.getParser().toJson(seRequests,
        ...
        return KeypleJsonParser.getParser().fromJson(response.getBody(),
    ...
    protected SeResponse processSeRequest(SeRequest seRequest, ChannelControl channelControl) {
        ...
        // Build the message
        JsonObject body = new JsonObject();
        body.addProperty("seRequest",
                KeypleJsonParser.getParser().toJson(seRequest, SeRequest.class));
        body.addProperty("channelControl", channelControl.name());
    ...
    public void addSeProtocolSetting(SeProtocol seProtocol, String protocolRule) {
        ...
        // Build the message
        JsonObject body = new JsonObject();
        body.addProperty("seProtocol",
                KeypleJsonParser.getParser().toJson(seProtocol, SeProtocol.class));
    ...
    public TransmissionMode getTransmissionMode() {
        ...
        KeypleMessageDto response =
                sendRequest(KeypleMessageDto.Action.GET_TRANSMISSION_MODE, null);
    ...
    private KeypleMessageDto sendRequest(KeypleMessageDto.Action action, JsonObject body) {
        ...
        // Build the message
        KeypleMessageDto message = new KeypleMessageDto()//
