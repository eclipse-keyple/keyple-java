...
public interface KeypleClientSync {
    ...
    /**
     * This method is called by {@link KeypleClientSyncNode} to send a {@link KeypleMessageDto} to
     * the server.<br>
     * You have to serialize and send the provided {@link KeypleMessageDto} to the server, then
     * retry the response which is a list of {@link KeypleMessageDto}.
     *
