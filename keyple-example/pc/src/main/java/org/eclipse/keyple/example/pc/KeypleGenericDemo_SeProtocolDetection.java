 ...
 */
public class KeypleGenericDemo_SeProtocolDetection implements ObservableReader.ReaderObserver {
                ...
                switch (protocol) {
                    case PROTOCOL_ISO14443_4:
                        ...
                        poRequests.add(new SeRequest(
                                new SeRequest.Selector(HoplinkSampleCommands.getAid()),
 ...
 */
enum CustomProtocolSetting implements SeProtocolSettingList {
