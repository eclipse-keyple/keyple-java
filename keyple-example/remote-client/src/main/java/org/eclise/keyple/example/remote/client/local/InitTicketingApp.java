...
import org.eclise.keyple.example.remote.server.RemoteSeReader;
...
import org.eclise.keyple.example.remote.server.transport.local.LocalServerListener;
...
public class InitTicketingApp implements org.eclipse.keyple.util.Observable.Observer {
    ...
    public void boot() {
        ...
        ServerListener serverListener = localServer.initServerListener();
        ...
        RemoteSePlugin remoteSePlugin = new RemoteSePlugin();

        logger.info("Observe SeRemotePLugin for Events");
        remoteSePlugin.addObserver(this);
        ...
        ((LocalServerListener) serverListener).setPlugin(remoteSePlugin);
