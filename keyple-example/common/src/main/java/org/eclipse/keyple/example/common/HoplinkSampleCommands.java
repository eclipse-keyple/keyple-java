...
/**
 * HoplinkSampleCommands operation helper class. Provides Aid and apdu request list for a basic Hoplink
 * demo transaction
 */
public class HoplinkSampleCommands {
    ...
    public static ReadRecordsCmdBuild poReadRecordCmd_T2Env = new ReadRecordsCmdBuild(PoRevision.REV3_1,
            (byte) 0x01, true, (byte) 0x14, (byte) 0x20);

    public static ReadRecordsCmdBuild poReadRecordCmd_T2Usage = new ReadRecordsCmdBuild(PoRevision.REV3_1,
    ...
    public static ReadRecordsCmdBuild poRatificationCommand = new ReadRecordsCmdBuild(PoRevision.REV3_1,
            (byte) 0x01, true, (byte) 0x14, (byte) 0x01);
